          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex flex-wrap gap-3">
              <a
                ...
                className="group relative rounded-xl p-[2px] bg-gradient-to-r from-orange-500 via-purple-500 via-blue-500 to-green-500 bg-[length:200%_100%] animate-shimmer hover:scale-105 transition-transform duration-300"
              >
                <div className="flex items-center gap-2 px-4 py-2.5 bg-black rounded-[10px]">
                  ...
                  <span className="text-white text-sm font-medium">TestFlight</span>
                </div>
              </a>
              <div className="group relative rounded-xl p-[2px] bg-gradient-to-r from-orange-500 via-purple-500 via-blue-500 to-green-500 bg-[length:200%_100%] animate-shimmer opacity-70">
                <div className="flex items-center gap-2 px-4 py-2.5 bg-black rounded-[10px]">
                  <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M3,20.5V3.5C3,2.91 3.34,2.39 3.84,2.15L13.69,12L3.84,21.85C3.34,21.6 3,21.09 3,20.5M16.81,15.12L6.05,21.34L14.54,12.85L16.81,15.12M20.16,10.81C20.5,11.08 20.75,11.5 20.75,12C20.75,12.5 20.5,12.92 20.16,13.19L17.89,14.5L15.39,12L17.89,9.5L20.16,10.81M6.05,2.66L16.81,8.88L14.54,11.15L6.05,2.66Z"/>
                  </svg>
                  <span className="text-white text-sm font-medium">{ANDROID_WAITLIST_LABEL}</span>
                </div>
              </div>
            </div>
          </div>
