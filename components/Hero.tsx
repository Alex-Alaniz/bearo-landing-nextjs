                ...
                <div className="px-6 mb-6 space-y-2.5">
                  ...
                  <div className="relative rounded-xl rainbow-border p-[2px]">
                    <a
                      ...
                      className="w-full py-2.5 bg-white text-black rounded-xl font-semibold text-xs flex items-center justify-center gap-2 active:scale-[0.98] transition-transform duration-150"
                    >
