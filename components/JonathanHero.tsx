  ...
  return (
    <section className="relative flex min-h-screen w-full flex-col items-center overflow-hidden bg-bearo-dark text-white selection:bg-white selection:text-black">
      ...
      <main className="relative flex flex-1 w-full max-w-6xl flex-col items-center justify-center px-6 pb-14 pt-8 md:px-10">
        ...
        <div className="relative z-30 mt-16 w-full max-w-xl">
          {!isSubmitted ? (
            <form onSubmit={handleCTA} className="relative">
              ...
              <div className="relative rounded-full rainbow-border p-[3px]">
                <div className="w-full h-full rounded-full bg-bearo-dark flex gap-2 p-1.5 md:h-16">
                  <input
                    type="email"
                    inputMode="email"
                    value={email}
